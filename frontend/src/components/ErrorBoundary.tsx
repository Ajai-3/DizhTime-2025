        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
          <div className="max-w-2xl w-full">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      The application encountered an error and couldn't continue. This might be due to a temporary issue or a bug in the code.
                    </p>
                  </div>
                  ...
                  <div className="text-center pt-4 border-t border-gray-700">
                    <p className="text-xs text-gray-500">
                      ...
                      <a href="mailto:dizhtime@gmail.com" className="text-main-color hover:text-orange-300">
                        dizhtime@gmail.com
                      </a>
                    </p>
                  </div>
            ...
            <div className="text-center mt-6">
              <h2 className="text-2xl font-bold"><span className='text-main-color'>Dizh</span> <span>Time</span></h2>
              <p className="text-gray-400 text-sm">Food Delivery Platform</p>
            </div>
          </div>
        </div>
      );
